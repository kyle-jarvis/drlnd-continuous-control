...
UNITY_ENV_URL="https://s3-us-west-1.amazonaws.com/udacity-drlnd/P2/Reacher"
...
declare -a envs=("one_agent/Reacher_Linux" "Reacher_Linux" "one_agent/Reacher_Linux_NoVis")
for ENV in "${envs[@]}"
do
    get_unity_env $ENV
done
